...
<body>
    ...
    <div>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="name" ErrorMessage="請輸入姓名" ForeColor="Red"></asp:RequiredFieldValidator>
        <br />
        <br />
        電話:<asp:TextBox ID="tele" runat="server"></asp:TextBox>
        <asp:RequiredFieldValidator ID="請輸入電話" runat="server" ControlToValidate="tele" ErrorMessage="請輸入電話" ForeColor="Red"></asp:RequiredFieldValidator>
        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="tele" ErrorMessage="格式錯誤" ForeColor="Red" ValidationExpression="[0-9]*"></asp:RegularExpressionValidator>
        <br />
        <br />
        優待卷號碼 :<asp:TextBox ID="com1" runat="server"></asp:TextBox>
        <br />
        <br />
        再輸入確認 :<asp:TextBox ID="com2" runat="server"></asp:TextBox>
        <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="com1" ControlToValidate="com2" EnableClientScript="False" ErrorMessage="輸入不一致" ForeColor="Red" ValueToCompare="123456"></asp:CompareValidator>
        <br />
        <br />
        再輸入email:<asp:TextBox ID="em" runat="server"></asp:TextBox>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="em" ErrorMessage="RequiredFieldValidator" ForeColor="Red">請輸入email</asp:RequiredFieldValidator>
        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="em" ErrorMessage="格式錯誤" ForeColor="Red" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
        <br />
        <br />
        <br />
        <br />
...
&nbsp;&nbsp;&nbsp;&nbsp; 單價:&nbsp;
        ...
        <br />
        <asp:RadioButtonList ID="R1" runat="server" Height="30px" RepeatDirection="Horizontal" style="margin-bottom: 0px" Width="567px">
        ...
        &nbsp;&nbsp;
        <br />
&nbsp;打八折後 :<asp:TextBox ID="pay" runat="server"></asp:TextBox>
        <br />
